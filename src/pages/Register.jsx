...
function Register({onActiveToLogin}){
    ...
    return(
        <>
            <div className="h-screen w-full bg-cover flex items-center px-40 justify-between" style={{ backgroundImage: `url(${gambarLatar})` }}>
                ...
                <div className="w-[60%] bg-[#FFFFFF]/40 max-h-[450px] h-full px-12 flex items-center rounded-[40px]">
