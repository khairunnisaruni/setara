...
const CardDaftarKuis = ({
    ...
    return (
        <div className="bg-white rounded-2xl shadow hover:shadow-lg transition p-2">
            ...
            {/* TOMBOL PLAY MENGARAHKAN KE LINK */}
            <a
                href={link}
                target="_blank"
                rel="noopener noreferrer"
                className="block mt-4 w-full bg-orange-500 text-white text-center font-semibold py-2 rounded-full hover:bg-orange-600 transition"
            >
                Play
            </a>
        </div>
