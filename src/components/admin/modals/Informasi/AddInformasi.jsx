  ...
  const AddInformasiModal = ({ isOpen, onClose, onSubmit }) => {
    // State TETAP SAMA (Sesuai UI kamu)
    ...
    const handleSubmit = async (e) => {
      ...
      // 👇 PERBAIKAN DISINI: Mapping data UI ke Database
      // UI pakai 'judul', Database minta 'judul_panduan'
      const dataToBackend = {
          judul_panduan: formData.judul,
          deskripsi_panduan: formData.deskripsi
      };

      try {
        // Kirim data yang sudah disesuaikan namanya
        await onSubmit(dataToBackend); 
        ...
        // Jangan tutup modal utama kalau gagal, biar user bisa coba lagi
        // onClose(); <--- Sebaiknya ini dihapus kalau gagal, tapi kalau mau tetap ditutup biarkan saja
          ...
          <div className="bg-white rounded-2xl p-6 w-[420px] shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  name="deskripsi" // TETAP deskripsi
                  rows="5"
                  onChange={handleChange}
